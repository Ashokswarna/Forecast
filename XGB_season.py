# -*- coding: utf-8 -*-
"""
Created on Tue Feb 19 17:00:19 2019
...
df = df.assign(season=pd.cut(df.Month,[0,2,4,7,10,12],
                             labels=['Winter','Spring','Summer','Rainy', 'Fall']))
#conditional selection
#foo = df.season[(df['Month']== 1)]

#drop Description, Address resolution and Dates

df.drop(['Dates', 'Descript', 'Address', 'Resolution', 'Hour', 'Month'], 
        axis = 1, inplace = True)
...
plt.bar(df['session'],df['Category'], color="blue")
